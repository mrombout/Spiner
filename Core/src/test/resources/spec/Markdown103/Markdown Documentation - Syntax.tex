...
\begin{enumerate}
  \item{\gbturn{Overview}
    \begin{enumerate}
      \item{\gbturn{Philosophy}}
      \item{\gbturn{Inline HTML}}
      \item{\gbturn{Automatic Escaping for Special Characters}}
    \end{enumerate}
  }
  \item{\gbturn{Block Elements}
    \begin{enumerate}
      \item{\gbturn{Paragraphs and Line Breaks}}
      \item{\gbturn{Headers}}
      \item{\gbturn{Blockquotes}}
      \item{\gbturn{Lists}}
      \item{\gbturn{Code Blocks}}
      \item{\gbturn{Horizontal Rules}}
    \end{enumerate}
  }
  \item{\gbturn{Span Elements}
    \begin{enumerate}
      \item{\gbturn{Links}}
      \item{\gbturn{Emphasis}}
      \item{\gbturn{Code}}
      \item{\gbturn{Images}}
    \end{enumerate}
  }
  \item{\gbturn{Miscellaneous}
    \begin{enumerate}
      \item{\gbturn{Backslash Escapes}}
      \item{\gbturn{Automatic Links}}
    \end{enumerate}
  }
\end{enumerate}
